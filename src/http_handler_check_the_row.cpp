...
#include <http_handler_check_the_row.hpp>
...
HttpHandlerCheckTheRow::HttpHandlerCheckTheRow(
...
std::string HttpHandlerCheckTheRow::HandleRequestThrow(
  ...
  //  response.SetStatus(headers::StatusCode::kOk);
  //  return response_new_game_body_serialize;
  //} else {
  //  response.SetStatus(headers::StatusCode::kBadRequest);
